...
class Writer():
    ...
    def clear_line(self, line: int) -> bool:
        ...
        if line < len(self.lines):
            ...
            self.device.fill_rect(0, row, self.screenwidth,
    ...
    def mytext(self, string: str, line: int, col: int = 0, invert=False) -> bool:
    ...
    def mytext_both_side(self, string1: str, string2: str, line: int, invert: bool = False) -> bool:
